...
const CaptainLogin = () => {
  ...
  return (
    <div className="p-7 flex flex-col justify-between h-screen">
      <div>
        <img className="w-16 mb-7" src="/assets/rapigo_logo.png" alt="" />
      ...
      <div>
        <Link
          to="/user-login"
          className="bg-orange-500 flex justify-center items-center text-white px-4 py-2 mb-5 font-semibold w-full rounded-md"
        >
          SignIn as User
        </Link>
      </div>
