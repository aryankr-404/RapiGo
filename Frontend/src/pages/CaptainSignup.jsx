    ...
    <div className= "p-7 flex flex-col justify-between h-screen">
      ...
      <h3 className='text-lg font-medium mb-2'>Vehicle Information</h3>
        <div className='flex justify-between gap-3'>
          ...
          <input
            className='bg-[#eeeeee] w-full text-base placeholder:text-base px-4 py-2 mb-3 rounded-md'
            required type="text" placeholder='Vehicle Plate Number'
        ...
        <button className='bg-black text-white px-4 py-2 mb-3 font-semibold w-full rounded-md'>Create Captain Account</button>
      </form>
