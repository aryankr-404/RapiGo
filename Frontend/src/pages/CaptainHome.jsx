...
const CaptainHome = () => {
  ...
  return (
    <div className="h-screen">
      ...
      <div ref={ridePopupPanelRef} className='z-10 fixed translate-y-full bottom-0 bg-white px-3 py-6 w-full '>
      ...
      <div ref={ConfirmRidePopupPanelRef} className='h-screen z-10 fixed translate-y-full bottom-0 bg-white px-3 py-4 w-full '>
